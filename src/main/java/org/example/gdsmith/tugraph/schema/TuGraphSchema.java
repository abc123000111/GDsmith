package org.example.gdsmith.tugraph.schema;
...
import org.example.gdsmith.tugraph.schema.TuGraphSchema.TuGraphTable;
...
public class TuGraphSchema extends CypherSchema<TuGraphGlobalState, TuGraphTable> {
    ...
    public static TuGraphSchema createEmptyNewSchema(){
        return new TuGraphSchema(new ArrayList<TuGraphTable>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    }

    //todo complete
    public TuGraphSchema(List<TuGraphTable> databaseTables, List<CypherLabelInfo> labels,
    ...
    public List<IFunctionInfo> getFunctions() {
        return Arrays.asList(TuGraphBuiltInFunctions.values());
    }
    ...
    public static class TuGraphTable extends AbstractTable<TuGraphTableColumn, TableIndex, TuGraphGlobalState> {

        //todo complete
        public TuGraphTable(String name, List<TuGraphTableColumn> columns, List<TableIndex> indexes, boolean isView) {
    ...
    public static class TuGraphTableColumn extends AbstractTableColumn<TuGraphTable, TuGraphDataType> {
        //todo complete
        public TuGraphTableColumn(String name, TuGraphTable table, TuGraphDataType type) {
