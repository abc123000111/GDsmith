...
public interface ICypherClause extends ITextRepresentation{
     ...
     * @return
     */
    List<INodePattern> getLocalNodeIdentifiers();

    /**
     * 本clause定义的relation identifier
     * @return
     */
    List<IRelationPattern> getLocalRelationIdentifiers();
     ...
     * @return
     */
    List<INodePattern> getAvailableNodeIdentifiers();

    /**
     * 本clause的作用域中可以使用的relation identifier，即where中可以使用的，包括了本地定义的和继承自之前clause的
     * @return
     */
    List<IRelationPattern> getAvailableRelationIdentifiers();
     ...
     * @return
     */
    List<INodePattern> getExtendableNodeIdentifiers();

    /**
     * 本clause继承自上一clause的relation identifier，可以在定义pattern和alias时使用
     * @return
     */
    List<IRelationPattern> getExtendablePatternIdentifiers();
