...
import gdsmith.cypher.mutation.ClauseScissorsMutator.ClauseScissorsMutatorContext;
import gdsmith.cypher.standard_ast.Return;

import java.util.List;
import java.util.stream.Collectors;

public class ClauseScissorsMutator <S extends CypherSchema<?,?>> extends ClauseVisitor<ClauseScissorsMutatorContext<S>> {
