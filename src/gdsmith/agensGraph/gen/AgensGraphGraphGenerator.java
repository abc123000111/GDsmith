...
public class AgensGraphGraphGenerator {
    ...
    public AgensGraphGraphGenerator(AgensGraphGlobalState globalState){
        this.globalState = globalState;
    }

    public static List<CypherQueryAdapter> createGraph(AgensGraphGlobalState globalState) throws Exception {
        return new AgensGraphGraphGenerator(globalState).generateGraph(globalState.getSchema());
    }
