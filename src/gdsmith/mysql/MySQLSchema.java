...
import gdsmith.common.schema.AbstractRelationalTable;
import gdsmith.common.schema.AbstractRowValue;
import gdsmith.common.schema.AbstractSchema;
import gdsmith.common.schema.AbstractTableColumn;
import gdsmith.common.schema.AbstractTables;
import gdsmith.common.schema.TableIndex;
import gdsmith.mysql.MySQLSchema.MySQLTable;
import gdsmith.mysql.MySQLSchema.MySQLTable.MySQLEngine;
    ...
    public static MySQLSchema fromConnection(SQLConnection con, String databaseName) throws SQLException {
        ...
        for (int i = 0; i < NR_SCHEMA_READ_TRIES; i++) {
            try {
                ...
                return new MySQLSchema(databaseTables); //动态地根据连接来获取数据库的schema
