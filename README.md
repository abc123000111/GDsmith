...
```
git clone https://github.com/gdsmith/gdsmith
cd gdsmith
mvn package -DskipTests
cd target
java -jar gdsmith-*.jar --num-threads 4 sqlite3 --oracle NoREC
```
...
* PingCAP has implemented PQS, NoREC, and TLP in a tool called [go-gdsmith](https://github.com/chaos-mesh/go-sqlancer).
